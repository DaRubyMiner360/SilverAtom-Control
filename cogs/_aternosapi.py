...
class AternosAPI():
    def __init__(self, headers, TOKEN, timeout=10):
        ...
        self.JavaSoftwares = ['Vanilla', 'Spigot', 'Forge', 'Magma', 'Snapshot', 'Bukkit', 'Paper', 'Modpacks',
                              'Glowstone']
    ...
    def StartServer(self):
        ...
        if serverstatus == "Online":
            ...
            startserver = self.filterCloudflare(url=f"https://aternos.org/panel/ajax/start.php", params=parameters,
            ...
            while ("Preparing" not in self.GetStatus() and self.GetStatus() != "Online"):
                time.sleep(10)
                startserver = self.filterCloudflare(url=f"https://aternos.org/panel/ajax/confirm.php",
    ...
    def StopServer(self):
        ...
        if serverstatus == "Offline":
            ...
            parameters['SEC'] = self.SEC
            parameters['TOKEN'] = self.TOKEN
            stopserver = self.filterCloudflare(url=f"https://aternos.org/panel/ajax/stop.php", params=parameters,
                                               headers=self.headers)
